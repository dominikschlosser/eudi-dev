...
Do not "fix" this by wiring request-object or issuer-metadata verification to a configured CA or trust list. The same reasoning that keeps the wallet from encrypting real data (ADR-0003) keeps it from asserting a trust decision it cannot make.
